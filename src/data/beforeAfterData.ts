...
export const beforeAfterData: BeforeAfterCase[] = [
  {
    ...
    description: 'Patient presented with severe enamel fluorosis staining, uneven incisal wear, and a narrow smile corridor. We designed a wider buccal corridor with multi-layered translucent ceramics that perfectly harmonized with her warm skin tone.',
    beforeImage: 'https://images.unsplash.com/photo-1588776814546-1ffcf47267a5?q=80&w=800&auto=format&fit=crop',
    afterImage: '/images/hero-smile.jpg',
  ...
  },
  {
    ...
    doctor: 'Dr. Elena Vance',
    duration: '60 Minutes',
    description: 'Extrinsic staining from espresso and tea eliminated in a single visit, elevating shade from A3.5 to BL2 (8 shades brighter) with zero post-treatment sensitivity.',
    beforeImage: 'https://images.unsplash.com/photo-1598256989800-fe5f95da9787?q=80&w=800&auto=format&fit=crop',
    afterImage: 'https://images.unsplash.com/photo-1571772996211-2f02c9727629?q=80&w=800&auto=format&fit=crop',
  ...
  },
  {
    ...
    description: 'Patient suffered traumatic root fracture of upper right central incisor. Guided surgical extraction and immediate implant placement preserved the natural gum papillae without bone loss.',
  ...
  },
  {
    ...
    duration: '7 Months',
    description: 'Severe lower anterior crowding and an asymmetric crossbite corrected without tooth extractions. Followed by minor edge contouring for a seamless smile arc.',
    beforeImage: 'https://images.unsplash.com/photo-1588776814546-1ffcf47267a5?q=80&w=800&auto=format&fit=crop',
    afterImage: 'https://images.unsplash.com/photo-1606811841689-23dfddce3e95?q=80&w=800&auto=format&fit=crop',
  ...
  },
  {
    ...
    duration: '4 Months',
    description: 'Restoration of vertical dimension lost to severe nocturnal bruxism (grinding). Restored youthful facial proportions, relieved chronic headaches, and delivered an exquisite, natural smile.',
    beforeImage: 'https://images.unsplash.com/photo-1629909613654-28e377c37b09?q=80&w=800&auto=format&fit=crop',
    afterImage: '/images/hero-smile.jpg',
