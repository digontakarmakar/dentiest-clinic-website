...
export const dentistsData: DentistProfile[] = [
  {
    ...
    title:
      "Specialist in Cosmetic Smile Architecture & Minimally Invasive Veneers",
    experienceYears: 16,
    image: publicImage("dr-elena.jpg"),
    ...
    philosophy:
      "A truly beautiful smile is not created with a cookie-cutter template. It is an individualized harmony of bone structure, lip curvature, enamel light translucency, and the unique spirit of the person wearing it.",
    quote:
      "Our mission is to replace dental anxiety with confidence, elevating dentistry from a medical procedure into an empowering wellness experience.",
    casesCount: 4200,
  },
  {
    id: "dr-marcus-chen",
    ...
    experienceYears: 18,
    image: publicImage("dr-marcus.jpg"),
    ...
    philosophy:
      "Engineering permanence requires surgical precision down to the fraction of a millimeter, but true healing requires empathy, patience, and absolute comfort.",
    quote:
      "Restoring a patient's ability to laugh, speak, and eat without hesitation is the most rewarding privilege in modern medicine.",
    casesCount: 6500,
  },
  {
    ...
    philosophy:
      "Orthodontics is the architecture beneath the cosmetic facade. When the alignment of teeth and jaw is in biological harmony, natural beauty follows effortlessly.",
    quote:
      "The right alignment does not just transform how you look in pictures—it transforms how you sleep, breathe, and live.",
    casesCount: 3800,
  },
];
