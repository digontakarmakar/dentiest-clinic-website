...
export const blogData: BlogPost[] = [
  {
    ...
    title:
      "The Art & Science of Digital Smile Design: Why Facial Symmetry Comes First",
    excerpt:
      "How modern 3D scanning, facial contour mapping, and biomimetic ceramics are replacing outdated one-size-fits-all cosmetic dentistry.",
    category: "Cosmetic Dentistry",
    author: {
      name: "Dr. Elena Vance",
      role: "Clinical Director",
      avatar: publicImage("dr-elena.jpg"),
    },
    ...
    content: {
      ...
      sections: [
        {
          ...
          keyTakeaway:
            "The most stunning smile is one that looks like you were naturally born with it, harmonizing seamlessly with your facial geometry.",
        },
        {
      ...
      conclusion:
        "A smile is your most intimate and enduring personal signature. By combining digital precision with conservative biological protocols, you achieve a result that is timeless, resilient, and unmistakably you.",
    },
    relatedSlugs: [
      "guided-dental-implants-lifelong-stability",
      "guided-biofilm-therapy-the-future-of-cleanings",
    ],
  },
  {
    id: "art-02",
    ...
    title:
      "Computer-Guided Dental Implants: Precision, Comfort & Lifelong Osseointegration",
    excerpt:
      "Exploring how low-radiation 3D CBCT imaging and custom 3D-printed surgical stents make tooth replacement faster, pain-free, and permanent.",
    category: "Dental Implants",
    author: {
      name: "Dr. Marcus Chen",
      role: "Lead Implantologist",
      avatar: publicImage("dr-marcus.jpg"),
    },
    ...
    content: {
      intro:
        "When a natural tooth is lost due to trauma or fracture, the surrounding bone begins to resorb rapidly. Dental implants remain the gold standard in restorative medicine because they are the only treatment that replaces the missing root, stimulating natural bone architecture and halting facial collapse.",
      sections: [
        {
          ...
          keyTakeaway:
            "Guided surgery minimizes surgical incisions, eliminates the need for extensive sutures, and reduces post-operative soreness by over 80%.",
        },
        {
      ...
      conclusion:
        "With modern computerized placement and Swiss-engineered fixtures, dental implants enjoy a clinical longevity and success rate exceeding 98% over a patient’s lifetime.",
    },
    relatedSlugs: [
      "the-art-and-science-of-digital-smile-design",
      "overcoming-dental-anxiety-spa-wellness-dentistry",
    ],
  },
  {
    id: "art-03",
    ...
    title:
      "Why Swiss Guided Biofilm Therapy is Replacing Traditional Dental Scraping",
    excerpt:
      "Say goodbye to painful metal scalers. Discover why warm water, micro-fine erythritol powder, and acoustic sensors are the new gold standard.",
    ...
    content: {
      intro:
        "For over a century, routine dental cleanings have been associated with cold water, vibrating metal hooks, and uncomfortable gum bleeding. Swiss innovation has fundamentally changed the paradigm with Guided Biofilm Therapy (GBT).",
      sections: [
        {
        ...
        },
        {
          ...
          keyTakeaway:
            "Safe for porcelain veneers, composite bonding, and dental implants.",
        },
      ],
      conclusion:
        "Oral hygiene should feel revitalizing and refreshing. GBT elevates preventive dentistry into a painless, spa-like ritual.",
    },
    relatedSlugs: [
      "the-art-and-science-of-digital-smile-design",
      "guided-dental-implants-lifelong-stability",
  ...
  },
  {
    ...
    title:
      "Overcoming Dental Anxiety: How Sensory Architecture Transforms the Clinic Experience",
    excerpt:
      "From acoustic soundscapes and memory-foam Italian leather to needle-free anesthesia, explore how comfort-first design eliminates fear.",
    ...
    readTime: "5 min read",
    coverImage: publicImage("treatment-suite.jpg"),
    content: {
      intro:
        "Studies show that over 60% of adults experience mild to severe dental phobia, often rooted in cold hospital environments, harsh smells, and painful childhood experiences. Smileora was architected to dismantle this anxiety entirely.",
      sections: [
        {
        ...
        },
        {
          ...
          keyTakeaway:
            "You remain in full control of your appointment at every moment.",
        },
      ],
      conclusion:
        "Healthcare should be calm, dignified, and empowering. When fear is removed, patients achieve radiant oral wellness with peace of mind.",
    },
    relatedSlugs: [
      "the-art-and-science-of-digital-smile-design",
      "guided-biofilm-therapy-the-future-of-cleanings",
