        ...
        <div className="container">
          <div className="intro-split-grid">
            ...
            <div>
              ...
              >
                For over a century, traditional dentistry was defined by
                clinical sterile whites, jarring acoustic drills, and hurried
                10-minute appointments. Dr. Elena Vance and Dr. Marcus Chen
                established Smileora to dismantle this paradigm.
              </p>
              <p
                style={{
                  marginTop: "16px",
              ...
              >
                Every element of our flagship studio—from our sound-dampened
                travertine acoustics and private garden-view operatory suites to
                computerized needle-free anesthesia—was designed with one
                priority: your physical and emotional serenity.
              </p>
              ...
              >
                <div
                  style={{
                    borderLeft: "3px solid var(--teal-muted)",
                    paddingLeft: "16px",
                  }}
                >
                  <h4
                  ...
                  <p style={{ fontSize: "0.9rem" }}>
                    We preserve natural tooth biology using microscopic adhesive
                    engineering.
                  </p>
                </div>
                <div
                ...
                >
                  ...
                  <p style={{ fontSize: "0.9rem" }}>
                    Aromatherapy, heated memory-foam chairs, and acoustic audio
                    therapy.
                  </p>
                </div>
              </div>
        ...
        <div className="container">
          <div className="trust-stats-grid">
            ...
            <StatCounter
              ...
              suffix=".1%"
              label="Implant Integration Rate"
            />
            <StatCounter
              end={100}
              suffix="%"
              label="Digital Scanning Protocol"
            />
          </div>
        </div>
      </section>
          ...
          <div className="pillars-grid">
            <div className="pillar-card">
              ...
              <p className="pillar-desc">
                We never judge, rush, or dismiss your concerns. Your comfort and
                voice lead every step of treatment.
              </p>
            </div>
            ...
            <div className="pillar-card">
              ...
              <p className="pillar-desc">
                We practice conservative dentistry—protecting healthy enamel and
                living tooth structure whenever possible.
              </p>
            </div>
            ...
            <div className="pillar-card">
              ...
              <p className="pillar-desc">
                Every restoration is individually hand-layered by master Swiss
                ceramists for lifelike light refraction.
              </p>
            </div>
            ...
            <div className="pillar-card">
              ...
              <p className="pillar-desc">
                Clear 3D visual walkthroughs, honest medical advice, and upfront
                treatment costs without surprises.
              </p>
            </div>
          </div>
        </div>
